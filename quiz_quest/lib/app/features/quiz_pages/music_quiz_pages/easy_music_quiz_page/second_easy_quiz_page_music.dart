...
class SecondEasyQuizPageMusic extends StatefulWidget {
  const SecondEasyQuizPageMusic({
    required this.image,
  ...
  @override
  State<SecondEasyQuizPageMusic> createState() =>
      _SecondEasyQuizPageMusicState();
}

class _SecondEasyQuizPageMusicState extends State<SecondEasyQuizPageMusic> {
  @override
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const EasyQuestionMusicQuizPage(),
                ));
              },
