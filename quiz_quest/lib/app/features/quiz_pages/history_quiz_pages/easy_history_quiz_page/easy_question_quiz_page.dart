...
import 'package:quiz_quest/app/features/quiz_pages/history_quiz_pages/easy_history_quiz_page/easy_history_answer_button.dart';
...
import 'package:quiz_quest/app/features/quiz_pages/history_quiz_pages/easy_history_quiz_page/easy_history_question_widget.dart';
    ...
    return Scaffold(
      body: MultiBlocProvider(
        providers: [
          BlocProvider(
            create: (context) =>
                getIt<HistoryCubit>()..getEasyHistoryCategory(),
          ),
          BlocProvider(
                      ...
                      setDurationEnd: (value) {
                        setState(() {
                          ...
                          if (easyHistoryBadAnswers == 3) {
                            ...
                            context
                                .read<RankingCubit>()
                                .updateEasyHistoryRankingPoints(
                                    easyHistoryGoodAnswers);
