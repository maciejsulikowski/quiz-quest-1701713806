...
class EasyGeneralAnswerButton extends StatefulWidget {
  ...
  @override
  State<EasyGeneralAnswerButton> createState() =>
      _EasyGeneralAnswerButtonState();
}

class _EasyGeneralAnswerButtonState extends State<EasyGeneralAnswerButton> {
  void onPressed() {
    if (isButtonDisabled) {
      return;
    }
    ...
    if (widget.isCorrectAnswer) {
      ...
      if (easyGeneralBadAnswers == 3) {
        ...
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) =>
                EasyGeneralLostLifePage(goodAnswers: easyGeneralGoodAnswers),
          ),
        );
      }
    }
