...
class FirstQuizPageMusic extends StatefulWidget {
  ...
  @override
  State<FirstQuizPageMusic> createState() => _FirstQuizPageMusicState();
}

class _FirstQuizPageMusicState extends State<FirstQuizPageMusic> {
  @override
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => SecondEasyQuizPageMusic(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: ElevatedButton(
        onPressed: () {
          Navigator.of(context).push(MaterialPageRoute(
              builder: (context) => SecondMediumQuizPageMusic(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: ElevatedButton(
        onPressed: () {
          Navigator.of(context).push(MaterialPageRoute(
              builder: (context) => SecondHardQuizPageMusic(
