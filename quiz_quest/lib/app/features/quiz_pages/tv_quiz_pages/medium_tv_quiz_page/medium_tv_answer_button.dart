...
class MediumTVAnswerButton extends StatefulWidget {
  ...
  @override
  State<MediumTVAnswerButton> createState() => _MediumTVAnswerButtonState();
}

class _MediumTVAnswerButtonState extends State<MediumTVAnswerButton> {
  void onPressed() {
    if (isButtonDisabled) {
      return;
    }
    ...
    if (widget.isCorrectAnswer) {
      ...
      if (mediumTvBadAnswers == 3) {
        ...
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) =>
                MediumTvLostLifePage(goodAnswers: mediumTvGoodAnswers),
          ),
        );
      }
    }
