...
class ResumeHardGeneralQuizPageGames extends StatefulWidget {
  const ResumeHardGeneralQuizPageGames({
  ...
  @override
  State<ResumeHardGeneralQuizPageGames> createState() =>
      _ResumeHardGeneralQuizPageGamesState();
}

class _ResumeHardGeneralQuizPageGamesState
    extends State<ResumeHardGeneralQuizPageGames> {
  @override
