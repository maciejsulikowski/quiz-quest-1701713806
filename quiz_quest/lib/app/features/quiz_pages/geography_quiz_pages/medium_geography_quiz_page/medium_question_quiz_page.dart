...
import 'package:quiz_quest/app/features/quiz_pages/geography_quiz_pages/medium_geography_quiz_page/medium_geography_answer_button.dart';
...
import 'package:quiz_quest/app/features/quiz_pages/geography_quiz_pages/medium_geography_quiz_page/medium_geography_question_widget.dart';
...
class MediumQuestionGeographyQuizPage extends StatefulWidget {
  ...
  @override
  State<MediumQuestionGeographyQuizPage> createState() =>
      _MediumQuestionGeographyQuizPageState();
}
...
bool isTimeUp = false;
late int mediumGeographyGoodAnswers;
late int mediumGeographyBadAnswers;
bool isCorrectAnswer = false;
String threeLives = '❤️❤️❤️';
String twoLives = ' ❤️❤️';
String oneLive = ' ❤️';

class _MediumQuestionGeographyQuizPageState
    extends State<MediumQuestionGeographyQuizPage> {
  int currentIndex = 0;
  ...
  @override
  void initState() {
    mediumGeographyGoodAnswers = 0;
    mediumGeographyBadAnswers = 0;
    currentAnswers = [];
    answerColors;
    ...
    return Scaffold(
      body: MultiBlocProvider(
        providers: [
          BlocProvider(
            create: (context) =>
                getIt<GeographyCubit>()..getMediumGeographyCategory(),
          ),
          BlocProvider(
        ...
        child: BlocListener<GeographyCubit, GeographyState>(
          listener: (context, state) async {
            if (state.status == Status.error) {
              ...
              context.read<GeographyCubit>().getMediumGeographyCategory();
            }
          },
                      ...
                      setDurationEnd: (value) {
                        setState(() {
                          ...
                          if (mediumGeographyBadAnswers == 3) {
                            context
                                .read<GeographyCubit>()
                                .updateMediumGeographyPoints(
                                    mediumGeographyGoodAnswers);
                            context
                                .read<RankingCubit>()
                                .updateMediumGeographyRankingPoints(
                                    mediumGeographyGoodAnswers);
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) =>
                                    MediumGeographyLostLifePage(
                                        goodAnswers:
                                            mediumGeographyGoodAnswers),
                              ),
                            );
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Good: $mediumGeographyGoodAnswers',
                                      style: GoogleFonts.aBeeZee(
                                          fontSize: 20,
                                          color: Colors.green,
                                          fontWeight: FontWeight.bold),
                                                    ...
                                                    setState(() {
                                                      if (currentIndex ==
                                                        ...
                                                        Navigator.of(context)
                                                          ...
                                                          MaterialPageRoute(
                                                            builder: (context) =>
                                                                ResumeMediumGeographyQuizPageGames(
                                                              badAnswers:
                                                                  mediumGeographyBadAnswers,
                                                              goodAnswers:
                                                                  mediumGeographyGoodAnswers,
                                                            ),
                                                          ),
