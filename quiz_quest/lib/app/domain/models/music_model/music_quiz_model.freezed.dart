...
MusicQuizModel _$MusicQuizModelFromJson(Map<String, dynamic> json) {
  return _MusicQuizModel.fromJson(json);
}

/// @nodoc
mixin _$MusicQuizModel {
  @JsonKey(name: "results")
  List<Results4> get results => throw _privateConstructorUsedError;

  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $MusicQuizModelCopyWith<MusicQuizModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $MusicQuizModelCopyWith<$Res> {
  factory $MusicQuizModelCopyWith(
          MusicQuizModel value, $Res Function(MusicQuizModel) then) =
      _$MusicQuizModelCopyWithImpl<$Res, MusicQuizModel>;
  @useResult
  $Res call({@JsonKey(name: "results") List<Results4> results});
}

/// @nodoc
class _$MusicQuizModelCopyWithImpl<$Res, $Val extends MusicQuizModel>
    implements $MusicQuizModelCopyWith<$Res> {
  _$MusicQuizModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$MusicQuizModelImplCopyWith<$Res>
    implements $MusicQuizModelCopyWith<$Res> {
  factory _$$MusicQuizModelImplCopyWith(_$MusicQuizModelImpl value,
          $Res Function(_$MusicQuizModelImpl) then) =
      __$$MusicQuizModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({@JsonKey(name: "results") List<Results4> results});
}
...
/// @nodoc
class __$$MusicQuizModelImplCopyWithImpl<$Res>
    extends _$MusicQuizModelCopyWithImpl<$Res, _$MusicQuizModelImpl>
    implements _$$MusicQuizModelImplCopyWith<$Res> {
  __$$MusicQuizModelImplCopyWithImpl(
      _$MusicQuizModelImpl _value, $Res Function(_$MusicQuizModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$MusicQuizModelImpl(
      null == results
          ? _value._results
          : results // ignore: cast_nullable_to_non_nullable
              as List<Results4>,
...
/// @nodoc
@JsonSerializable()
class _$MusicQuizModelImpl implements _MusicQuizModel {
  _$MusicQuizModelImpl(@JsonKey(name: "results") final List<Results4> results)
      : _results = results;

  factory _$MusicQuizModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$MusicQuizModelImplFromJson(json);
  ...
  @override
  String toString() {
    return 'MusicQuizModel(results: $results)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$MusicQuizModelImplCopyWith<_$MusicQuizModelImpl> get copyWith =>
      __$$MusicQuizModelImplCopyWithImpl<_$MusicQuizModelImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$MusicQuizModelImplToJson(
      this,
    );
  }
}

abstract class _MusicQuizModel implements MusicQuizModel {
  factory _MusicQuizModel(
          @JsonKey(name: "results") final List<Results4> results) =
      _$MusicQuizModelImpl;

  factory _MusicQuizModel.fromJson(Map<String, dynamic> json) =
      _$MusicQuizModelImpl.fromJson;
