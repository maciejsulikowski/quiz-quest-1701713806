...
class ResumeEasyHistoryQuizPageGames extends StatefulWidget {
  const ResumeEasyHistoryQuizPageGames({
  ...
  @override
  State<ResumeEasyHistoryQuizPageGames> createState() =>
      _ResumeEasyHistoryQuizPageGamesState();
}

class _ResumeEasyHistoryQuizPageGamesState
    extends State<ResumeEasyHistoryQuizPageGames> {
  @override
