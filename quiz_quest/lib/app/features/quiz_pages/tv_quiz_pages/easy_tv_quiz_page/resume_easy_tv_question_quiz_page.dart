...
class ResumeEasyTvQuizPageGames extends StatefulWidget {
  const ResumeEasyTvQuizPageGames({
  ...
  @override
  State<ResumeEasyTvQuizPageGames> createState() =>
      _ResumeEasyTvQuizPageGamesState();
}

class _ResumeEasyTvQuizPageGamesState
    extends State<ResumeEasyTvQuizPageGames> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ResumePage(
        badAnswers: easyTvBadAnswers,
