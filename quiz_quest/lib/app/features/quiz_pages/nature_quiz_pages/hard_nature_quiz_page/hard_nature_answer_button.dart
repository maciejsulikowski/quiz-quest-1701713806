...
class HardNatureAnswerButton extends StatefulWidget {
  ...
  @override
  State<HardNatureAnswerButton> createState() => _HardNatureAnswerButtonState();
}

class _HardNatureAnswerButtonState extends State<HardNatureAnswerButton> {
  void onPressed() {
    if (isButtonDisabled) {
      return;
    }
    ...
    if (widget.isCorrectAnswer) {
      ...
      if (hardNatureBadAnswers == 3) {
        ...
        context
            .read<RankingCubit>()
            .updateHardNatureRankingPoints(hardNatureGoodAnswers);
