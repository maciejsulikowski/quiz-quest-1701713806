...
class ResumeMediumNatureQuizPageGames extends StatefulWidget {
  const ResumeMediumNatureQuizPageGames({
  ...
  @override
  State<ResumeMediumNatureQuizPageGames> createState() =>
      _ResumeMediumNatureQuizPageGamesState();
}

class _ResumeMediumNatureQuizPageGamesState
    extends State<ResumeMediumNatureQuizPageGames> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ResumePage(
        badAnswers: mediumNatureBadAnswers,
