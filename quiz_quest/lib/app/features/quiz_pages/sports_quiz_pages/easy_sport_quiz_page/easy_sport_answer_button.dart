...
class EasySportAnswerButton extends StatefulWidget {
  ...
  @override
  State<EasySportAnswerButton> createState() => _EasySportAnswerButtonState();
}

class _EasySportAnswerButtonState extends State<EasySportAnswerButton> {
  void onPressed() {
    if (isButtonDisabled) {
      return;
    }
    ...
    if (widget.isCorrectAnswer) {
      ...
      if (easySportBadAnswers == 3) {
        ...
        context.read<RankingCubit>().updateEasySportRankingPoints(easySportGoodAnswers);
