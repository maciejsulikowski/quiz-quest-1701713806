...
class SecondHardQuizPageGeneral extends StatefulWidget {
  const SecondHardQuizPageGeneral({
    required this.image,
  ...
  @override
  State<SecondHardQuizPageGeneral> createState() =>
      _SecondHardQuizPageGeneralState();
}

class _SecondHardQuizPageGeneralState extends State<SecondHardQuizPageGeneral> {
  @override
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const HardQuestionGeneralQuizPage(),
                ));
              },
