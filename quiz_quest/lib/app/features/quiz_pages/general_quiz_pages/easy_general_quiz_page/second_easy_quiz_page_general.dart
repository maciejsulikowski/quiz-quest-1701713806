...
class SecondEasyQuizPageGeneral extends StatefulWidget {
  const SecondEasyQuizPageGeneral({
    required this.image,
  ...
  @override
  State<SecondEasyQuizPageGeneral> createState() =>
      _SecondEasyQuizPageGeneralState();
}

class _SecondEasyQuizPageGeneralState extends State<SecondEasyQuizPageGeneral> {
  @override
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const EasyQuestionGeneralQuizPage(),
                ));
              },
