...
class SecondEasyQuizPageGames extends StatefulWidget {
  const SecondEasyQuizPageGames({
    required this.image,
  ...
  @override
  State<SecondEasyQuizPageGames> createState() =>
      _SecondEasyQuizPageGamesState();
}

class _SecondEasyQuizPageGamesState extends State<SecondEasyQuizPageGames> {
  @override
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const EasyQuestionGamesQuizPage(),
                ));
              },
