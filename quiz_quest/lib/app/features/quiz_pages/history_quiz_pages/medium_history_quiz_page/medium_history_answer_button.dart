...
class MediumHistoryAnswerButton extends StatefulWidget {
  ...
  @override
  State<MediumHistoryAnswerButton> createState() =>
      _MediumHistoryAnswerButtonState();
}

class _MediumHistoryAnswerButtonState extends State<MediumHistoryAnswerButton> {
  void onPressed() {
    if (isButtonDisabled) {
      return;
    }
      ...
      if (mediumHistoryBadAnswers == 3) {
        context
            ...
            .updateMediumHistoryPoints(mediumHistoryGoodAnswers);
             context
            .read<RankingCubit>()
            .updateMediumHistoryRankingPoints(mediumHistoryGoodAnswers);
