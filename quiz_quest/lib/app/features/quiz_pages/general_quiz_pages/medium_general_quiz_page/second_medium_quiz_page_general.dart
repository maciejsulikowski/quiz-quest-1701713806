...
class SecondMediumQuizPageGeneral extends StatefulWidget {
  const SecondMediumQuizPageGeneral({
    required this.image,
  ...
  @override
  State<SecondMediumQuizPageGeneral> createState() =>
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const MediumQuestionGeneralQuizPage(),
                ));
              },
