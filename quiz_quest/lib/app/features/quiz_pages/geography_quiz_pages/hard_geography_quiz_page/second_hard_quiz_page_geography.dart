...
class SecondHardQuizPageGeography extends StatefulWidget {
  const SecondHardQuizPageGeography({
    required this.image,
  ...
  @override
  State<SecondHardQuizPageGeography> createState() =>
      _SecondHardQuizPageGeographyState();
}

class _SecondHardQuizPageGeographyState
    extends State<SecondHardQuizPageGeography> {
  @override
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const HardQuestionGeographyQuizPage(),
                ));
              },
