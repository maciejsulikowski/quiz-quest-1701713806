...
class EasyLostLifePage extends StatefulWidget {
  const EasyLostLifePage({
  ...
  @override
  State<EasyLostLifePage> createState() => _EasyLostLifePageState();
}

class _EasyLostLifePageState extends State<EasyLostLifePage> {
  @override
