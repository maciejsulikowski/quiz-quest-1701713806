...
class EasySportLostLifePage extends StatefulWidget {
  const EasySportLostLifePage({
  ...
  @override
  State<EasySportLostLifePage> createState() => _EasySportLostLifePageState();
}

class _EasySportLostLifePageState extends State<EasySportLostLifePage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ResumePage(goodAnswers: easySportGoodAnswers),
    );
  }
}
