...
class EasyTvLostLifePage extends StatefulWidget {
  const EasyTvLostLifePage({
  ...
  @override
  State<EasyTvLostLifePage> createState() => _EasyTvLostLifePageState();
}

class _EasyTvLostLifePageState extends State<EasyTvLostLifePage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ResumePage(goodAnswers: easyTvGoodAnswers),
    );
  }
}
