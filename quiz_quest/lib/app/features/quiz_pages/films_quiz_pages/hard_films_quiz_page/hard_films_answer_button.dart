...
class HardFilmsAnswerButton extends StatefulWidget {
  ...
  @override
  State<HardFilmsAnswerButton> createState() => _HardFilmsAnswerButtonState();
}

class _HardFilmsAnswerButtonState extends State<HardFilmsAnswerButton> {
  void onPressed() {
    if (isButtonDisabled) {
      return;
    }
    ...
    if (widget.isCorrectAnswer) {
      ...
      if (hardFilmsBadAnswers == 3) {
        ...
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) =>
                HardLostLifePage(goodAnswers: hardFilmsGoodAnswers),
          ),
        );
      }
    }
