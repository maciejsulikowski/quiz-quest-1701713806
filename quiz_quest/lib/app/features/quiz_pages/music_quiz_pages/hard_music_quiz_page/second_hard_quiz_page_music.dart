...
class SecondHardQuizPageMusic extends StatefulWidget {
  const SecondHardQuizPageMusic({
    required this.image,
  ...
  @override
  State<SecondHardQuizPageMusic> createState() =>
      _SecondHardQuizPageMusicState();
}

class _SecondHardQuizPageMusicState extends State<SecondHardQuizPageMusic> {
  @override
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const HardQuestionMusicQuizPage(),
                ));
              },
