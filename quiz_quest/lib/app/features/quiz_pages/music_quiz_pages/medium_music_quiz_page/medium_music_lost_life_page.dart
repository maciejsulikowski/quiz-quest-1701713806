...
class MediumMusicLostLifePage extends StatefulWidget {
  const MediumMusicLostLifePage({
  ...
  @override
  State<MediumMusicLostLifePage> createState() => MediumMusicLostLifePageState();
}

class MediumMusicLostLifePageState extends State<MediumMusicLostLifePage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ResumePage(goodAnswers: mediumMusicGoodAnswers),
    );
  }
}
