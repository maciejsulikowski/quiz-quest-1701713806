...
class SecondMediumQuizPageHistory extends StatefulWidget {
  const SecondMediumQuizPageHistory({
    required this.image,
  ...
  @override
  State<SecondMediumQuizPageHistory> createState() =>
      _SecondMediumQuizPageHistoryState();
}

class _SecondMediumQuizPageHistoryState
    extends State<SecondMediumQuizPageHistory> {
  @override
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const MediumQuestionHistoryQuizPage(),
                ));
              },
