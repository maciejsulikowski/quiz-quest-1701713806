...
import 'package:quiz_quest/app/features/quiz_pages/music_quiz_pages/medium_music_quiz_page/medium_music_answer_button.dart';
...
import 'package:quiz_quest/app/features/quiz_pages/music_quiz_pages/medium_music_quiz_page/medium_music_question_widget.dart';
...
class MediumQuestionMusicQuizPage extends StatefulWidget {
  ...
  @override
  State<MediumQuestionMusicQuizPage> createState() =>
      MediumQuestionMusicQuizPageState();
}
...
bool isTimeUp = false;
late int mediumMusicGoodAnswers;
late int mediumMusicBadAnswers;
bool isCorrectAnswer = false;
String threeLives = '❤️❤️❤️';
String twoLives = ' ❤️❤️';
String oneLive = ' ❤️';

class MediumQuestionMusicQuizPageState
    extends State<MediumQuestionMusicQuizPage> {
  int currentIndex = 0;
  ...
  @override
  void initState() {
    mediumMusicGoodAnswers = 0;
    mediumMusicBadAnswers = 0;
    currentAnswers = [];
    answerColors;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: MultiBlocProvider(
        providers: [
          BlocProvider(
            create: (context) => getIt<MusicCubit>()..getMediumMusicCategory(),
          ),
          BlocProvider(
        ...
        child: BlocListener<MusicCubit, MusicState>(
          listener: (context, state) async {
            if (state.status == Status.error) {
              ...
              context.read<MusicCubit>().getMediumMusicCategory();
            }
          },
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: Text(
                                  mediumMusicBadAnswers == 0
                                      ? threeLives
                                      : mediumMusicBadAnswers == 1
                                          ? twoLives
                                          : mediumMusicBadAnswers == 2
                                              ? oneLive
                                              : '',
                                  style: GoogleFonts.aBeeZee(
                                    fontSize: 20,
                    ...
                    CountDownTimer(
                      setDurationEnd: (value) {
                        setState(() {
                          ...
                          isTimeUp = true;
                          if (mediumMusicBadAnswers == 3) {
                            context.read<MusicCubit>().updateMediumMusicPoints(
                                mediumMusicGoodAnswers);
                            context
                                .read<RankingCubit>()
                                .updateMediumMusicRankingPoints(
                                    mediumMusicGoodAnswers);
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) => MediumMusicLostLifePage(
                                                    ...
                                                    setState(() {
                                                      if (currentIndex ==
                                                        ...
                                                        Navigator.of(context)
                                                          ...
                                                          MaterialPageRoute(
                                                            builder: (context) =>
                                                                ResumeMediumMusicQuizPageGames(
                                                              badAnswers:
                                                                  mediumMusicBadAnswers,
                                                              goodAnswers:
                                                                  mediumMusicGoodAnswers,
                                                            ),
                                                          ),
