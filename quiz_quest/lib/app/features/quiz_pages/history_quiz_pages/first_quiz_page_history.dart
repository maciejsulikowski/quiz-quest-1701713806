...
class _FirstQuizPageHistoryState extends State<FirstQuizPageHistory> {
  @override
...
class QuizzPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          HistoryCubit(QuizRepository(QuizCategoriesDataSource()))
            ..getHistoryCategory(),
      child: BlocBuilder<HistoryCubit, HistoryState>(
        builder: (context, state) {
          final historyModel = state.historyQuizModel;
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => QuestionQuizPageHistory(
                                model: historyModel,
                              )));
                    },
