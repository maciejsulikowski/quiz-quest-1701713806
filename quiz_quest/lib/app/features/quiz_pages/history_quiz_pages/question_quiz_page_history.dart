...
class QuestionQuizPageHistory extends StatefulWidget {
  const QuestionQuizPageHistory({
    required this.model,
    super.key,
  });
  ...
  @override
  State<QuestionQuizPageHistory> createState() =>
      _QuestionQuizPageHistoryState();
}

class _QuestionQuizPageHistoryState extends State<QuestionQuizPageHistory> {
  @override
