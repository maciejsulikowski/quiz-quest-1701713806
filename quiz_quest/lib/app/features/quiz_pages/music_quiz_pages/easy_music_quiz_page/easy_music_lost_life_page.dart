...
class EasyMusicLostLifePage extends StatefulWidget {
  const EasyMusicLostLifePage({
  ...
  @override
  State<EasyMusicLostLifePage> createState() => _EasyMusicLostLifePageState();
}

class _EasyMusicLostLifePageState extends State<EasyMusicLostLifePage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ResumePage(goodAnswers: easyMusicGoodAnswers),
    );
  }
}
