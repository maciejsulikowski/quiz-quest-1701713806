...
class HardGeneralLostLifePage extends StatefulWidget {
  const HardGeneralLostLifePage({
  ...
  @override
  State<HardGeneralLostLifePage> createState() =>
      _HardGeneralLostLifePageState();
}

class _HardGeneralLostLifePageState extends State<HardGeneralLostLifePage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ResumePage(goodAnswers: hardGeneralGoodAnswers),
    );
  }
}
