...
import 'package:quiz_quest/app/features/quiz_pages/games_quiz_pages/medium_games_quiz_page/medium_games_answer_button.dart';
...
import 'package:quiz_quest/app/features/quiz_pages/games_quiz_pages/medium_games_quiz_page/medium_games_question_widget.dart';
...
class MediumQuestionGamesQuizPage extends StatefulWidget {
  ...
  @override
  State<MediumQuestionGamesQuizPage> createState() =>
      _MediumQuestionGamesQuizPageState();
}
...
bool isTimeUp = false;
late int mediumGamesGoodAnswers;
late int mediumGamesBadAnswers;
...
class _MediumQuestionGamesQuizPageState
  ...
  @override
  void initState() {
    mediumGamesGoodAnswers = 0;
    mediumGamesBadAnswers = 0;
    currentAnswers = [];
    answerColors;
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                'Score: ${mediumGamesGoodAnswers * 20}',
                            ...
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) => MediumGamesLostLifePage(
                                    goodAnswers: mediumGamesGoodAnswers),
                              ),
                            );
                          }
                        });
