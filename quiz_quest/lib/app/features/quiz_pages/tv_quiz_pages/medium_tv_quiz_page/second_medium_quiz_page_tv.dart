...
class SecondMediumQuizPageTv extends StatefulWidget {
  const SecondMediumQuizPageTv({
    required this.image,
  ...
  @override
  State<SecondMediumQuizPageTv> createState() => _SecondMediumQuizPageTvState();
}

class _SecondMediumQuizPageTvState extends State<SecondMediumQuizPageTv> {
  @override
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const MediumQuestionTvQuizPage(),
                ));
              },
