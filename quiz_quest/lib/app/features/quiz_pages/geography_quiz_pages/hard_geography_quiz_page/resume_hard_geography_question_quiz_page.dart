...
class ResumeHardGeographyQuizPageGames extends StatefulWidget {
  const ResumeHardGeographyQuizPageGames({
  ...
  @override
  State<ResumeHardGeographyQuizPageGames> createState() =>
      _ResumeHardGeographyQuizPageGamesState();
}

class _ResumeHardGeographyQuizPageGamesState
    extends State<ResumeHardGeographyQuizPageGames> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ResumePage(
        badAnswers: mediumGeographyBadAnswers,
