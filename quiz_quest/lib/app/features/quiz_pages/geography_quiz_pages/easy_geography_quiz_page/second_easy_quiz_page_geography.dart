...
class SecondEasyQuizPageGeography extends StatefulWidget {
  const SecondEasyQuizPageGeography({
    required this.image,
  ...
  @override
  State<SecondEasyQuizPageGeography> createState() =>
      _SecondEasyQuizPageGeographyState();
}

class _SecondEasyQuizPageGeographyState extends State<SecondEasyQuizPageGeography> {
  @override
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const EasyQuestionGeographyQuizPage(),
                ));
              },
