...
class ResumeEasySportQuizPageGames extends StatefulWidget {
  const ResumeEasySportQuizPageGames({
  ...
  @override
  State<ResumeEasySportQuizPageGames> createState() =>
      _ResumeEasySportQuizPageGamesState();
}

class _ResumeEasySportQuizPageGamesState
    extends State<ResumeEasySportQuizPageGames> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ResumePage(
        badAnswers: easySportBadAnswers,
