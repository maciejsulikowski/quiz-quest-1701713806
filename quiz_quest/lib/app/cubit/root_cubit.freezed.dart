...
mixin _$RootState {
  ...
  String? get passwordMessage => throw _privateConstructorUsedError;
...
class _$RootStateCopyWithImpl<$Res, $Val extends RootState>
  ...
  $Res call({
    ...
    Object? passwordMessage = freezed,
  }) {
    return _then(_value.copyWith(
      ...
      errorMessage: freezed == errorMessage
          ...
          : errorMessage // ignore: cast_nullable_to_non_nullable
              as String?,
      passwordMessage: freezed == passwordMessage
          ? _value.passwordMessage
          : passwordMessage // ignore: cast_nullable_to_non_nullable
              as String?,
    ) as $Val);
  }
}
...
class _$RootStateImpl implements _RootState {
  ...
  @override
  String toString() {
    return 'RootState(user: $user, status: $status, errorMessage: $errorMessage, passwordMessage: $passwordMessage)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.passwordMessage, passwordMessage) ||
                other.passwordMessage == passwordMessage));
  }

  @override
  int get hashCode =>
      Object.hash(runtimeType, user, status, errorMessage, passwordMessage);
...
abstract class _RootState implements RootState {
  factory _RootState(
      ...
      final Status status,
      final String? errorMessage,
      final String? passwordMessage}) = _$RootStateImpl;
