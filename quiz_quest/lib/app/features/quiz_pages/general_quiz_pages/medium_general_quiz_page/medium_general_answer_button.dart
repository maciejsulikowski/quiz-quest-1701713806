...
class MediumGeneralAnswerButton extends StatefulWidget {
  ...
  @override
  State<MediumGeneralAnswerButton> createState() =>
      _MediumGeneralAnswerButtonState();
}

class _MediumGeneralAnswerButtonState extends State<MediumGeneralAnswerButton> {
  void onPressed() {
    if (isButtonDisabled) {
      return;
    }
