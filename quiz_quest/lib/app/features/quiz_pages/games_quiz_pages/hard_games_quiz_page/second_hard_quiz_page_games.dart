...
class SecondHardQuizPageGames extends StatefulWidget {
  const SecondHardQuizPageGames({
    required this.image,
  ...
  @override
  State<SecondHardQuizPageGames> createState() =>
      _SecondHardQuizPageGamesState();
}

class _SecondHardQuizPageGamesState extends State<SecondHardQuizPageGames> {
  @override
    ...
    return Container(
      ...
      child: ListView(
        children: [
          ...
          Center(
            child: Text(
              'Easy category points: $hardCategory💎',
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const HardQuestionGamesQuizPage(),
                ));
              },
