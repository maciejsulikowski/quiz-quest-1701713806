...
class SecondHardQuizPageHistory extends StatefulWidget {
  const SecondHardQuizPageHistory({
    required this.image,
  ...
  @override
  State<SecondHardQuizPageHistory> createState() =>
      _SecondHardQuizPageHistoryState();
}

class _SecondHardQuizPageHistoryState
    extends State<SecondHardQuizPageHistory> {
  @override
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const HardQuestionHistoryQuizPage(),
                ));
              },
