...
class MediumQuestionMusicQuizPageState extends State<MediumQuestionMusicQuizPage> {
  int currentIndex = 0;
                      ...
                      setDurationEnd: (value) {
                        setState(() {
                          ...
                          if (mediumMusicBadAnswers == 3) {
                            context
                                .read<MusicCubit>()
                                .updateMediumMusicPoints(mediumMusicGoodAnswers);
...
class _AnswerButtonState extends State<AnswerButton> {
  void onPressed() {
    ...
    if (widget.isCorrectAnswer) {
      ...
      mediumMusicGoodAnswers += 1;
    } else {
      widget.colorFunction(Colors.red, widget.index);
      mediumMusicBadAnswers += 1;
      if (mediumMusicBadAnswers == 3) {
        context.read<MusicCubit>().updateMediumMusicPoints(mediumMusicGoodAnswers);
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) =>
                MediumMusicLostLifePage(goodAnswers: mediumMusicGoodAnswers),
          ),
        );
      }
    }
