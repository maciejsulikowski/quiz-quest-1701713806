...
class MediumGeographyLostLifePage extends StatefulWidget {
  const MediumGeographyLostLifePage({
  ...
  @override
  State<MediumGeographyLostLifePage> createState() =>
      _MediumGeographyLostLifePageState();
}

class _MediumGeographyLostLifePageState extends State<MediumGeographyLostLifePage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ResumePage(goodAnswers: mediumGeographyGoodAnswers),
    );
  }
}
