...
class SecondMediumQuizPageGeography extends StatefulWidget {
  const SecondMediumQuizPageGeography({
    required this.image,
  ...
  @override
  State<SecondMediumQuizPageGeography> createState() =>
      _SecondMediumQuizPageGeographyState();
}

class _SecondMediumQuizPageGeographyState
    extends State<SecondMediumQuizPageGeography> {
  @override
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const MediumQuestionGeographyQuizPage(),
                ));
              },
