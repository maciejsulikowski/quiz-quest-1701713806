...
class SecondMediumQuizPageMusic extends StatefulWidget {
  const SecondMediumQuizPageMusic({
    required this.image,
  ...
  @override
  State<SecondMediumQuizPageMusic> createState() =>
      _SecondMediumQuizPageMusicState();
}

class _SecondMediumQuizPageMusicState extends State<SecondMediumQuizPageMusic> {
  @override
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const MediumQuestionMusicQuizPage(),
                ));
              },
