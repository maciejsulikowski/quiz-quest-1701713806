...
abstract class QuizCategoriesRetrofitDataSource {
  ...
  @GET('/api.php?amount=50&category=11&difficulty=easy&type=multiple')
  Future<FilmsQuizModel> getEasyFilmCategory();
  @GET('/api.php?amount=50&category=11&difficulty=medium&type=multiple')
  Future<FilmsQuizModel> getMediumFilmCategory();
  @GET('/api.php?amount=40&category=11&difficulty=hard&type=multiple')
  Future<FilmsQuizModel> getHardFilmCategory();
  @GET('/api.php?amount=50&category=15&difficulty=easy&type=multiple')
  Future<GamesQuizModel> getEasyGamesCategory();
  @GET('/api.php?amount=50&category=15&difficulty=medium&type=multiple')
  Future<GamesQuizModel> getMediumGamesCategory();
  @GET('/api.php?amount=50&category=15&difficulty=hard&type=multiple')
  Future<GamesQuizModel> getHardGamesCategory();
  @GET('/api.php?amount=50&category=12&difficulty=easy&type=multiple')
  Future<MusicQuizModel> getEasyMusicCategory();
  @GET('/api.php?amount=50&category=12&difficulty=medium&type=multiple')
  Future<MusicQuizModel> getMediumMusicCategory();
  @GET('/api.php?amount=50&category=12&difficulty=hard&type=multiple')
  Future<MusicQuizModel> getHardMusicCategory();
  @GET('/api.php?amount=50&category=17&difficulty=easy&type=multiple')
  Future<NatureQuizModel> getEasyNatureCategory();
  @GET('/api.php?amount=50&category=17&difficulty=medium&type=multiple')
  Future<NatureQuizModel> getMediumNatureCategory();
  @GET('/api.php?amount=50&category=17&difficulty=hard&type=multiple')
  Future<NatureQuizModel> getHardNatureCategory();
  @GET('/api.php?amount=50&category=22&difficulty=easy&type=multiple')
  Future<GeographyQuizModel> getEasyGeographyCategory();
  @GET('/api.php?amount=50&category=22&difficulty=medium&type=multiple')
  Future<GeographyQuizModel> getMediumGeographyCategory();
  @GET('/api.php?amount=50&category=22&difficulty=hard&type=multiple')
  Future<GeographyQuizModel> getHardGeographyCategory();
  @GET('/api.php?amount=50&category=23&difficulty=easy&type=multiple')
  Future<HistoryQuizModel> getEasyHistoryCategory();
  @GET('/api.php?amount=50&category=23&difficulty=medium&type=multiple')
  Future<HistoryQuizModel> getMediumHistoryCategory();
  @GET('/api.php?amount=50&category=23&difficulty=hard&type=multiple')
  Future<HistoryQuizModel> getHardHistoryCategory();
  @GET('/api.php?amount=40&category=21&difficulty=easy&type=multiple')
  Future<SportsQuizModel> getEasySportCategory();
  @GET('/api.php?amount=50&category=21&difficulty=medium&type=multiple')
  Future<SportsQuizModel> getMediumSportCategory();
  @GET('/api.php?amount=20&category=21&difficulty=hard&type=multiple')
  Future<SportsQuizModel> getHardSportCategory();
  @GET('/api.php?amount=50&category=14&difficulty=easy&type=multiple')
  Future<TVQuizModel> getEasyTVCategory();
  @GET('/api.php?amount=50&category=14&difficulty=medium&type=multiple')
  Future<TVQuizModel> getMediumTVCategory();
  @GET('/api.php?amount=25&category=14&difficulty=hard&type=multiple')
  Future<TVQuizModel> getHardTVCategory();
  @GET('/api.php?amount=50&category=9&difficulty=easy&type=multiple')
  ...
  @GET('/api.php?amount=50&category=9&difficulty=hard&type=multiple')
