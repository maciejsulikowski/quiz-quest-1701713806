...
class HardGamesLostLifePage extends StatefulWidget {
  const HardGamesLostLifePage({
  ...
  @override
  State<HardGamesLostLifePage> createState() => _HardGamesLostLifePageState();
}

class _HardGamesLostLifePageState extends State<HardGamesLostLifePage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ResumePage(goodAnswers: hardGamesGoodAnswers),
    );
  }
}
