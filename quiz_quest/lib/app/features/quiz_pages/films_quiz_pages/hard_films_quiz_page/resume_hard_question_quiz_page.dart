...
class ResumeHardQuizPageFilms extends StatefulWidget {
  const ResumeHardQuizPageFilms({
  ...
  @override
  State<ResumeHardQuizPageFilms> createState() =>
      _ResumeHardQuizPageFilmsState();
}

class _ResumeHardQuizPageFilmsState extends State<ResumeHardQuizPageFilms> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ResumePage(
        badAnswers: hardFilmsBadAnswers,
