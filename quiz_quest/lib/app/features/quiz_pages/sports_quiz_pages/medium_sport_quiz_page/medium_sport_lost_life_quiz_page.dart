...
class MediumSportLostLifePage extends StatefulWidget {
  const MediumSportLostLifePage({
  ...
  @override
  State<MediumSportLostLifePage> createState() => _MediumSportLostLifePageState();
}

class _MediumSportLostLifePageState extends State<MediumSportLostLifePage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ResumePage(goodAnswers: mediumSportGoodAnswers),
    );
  }
}
