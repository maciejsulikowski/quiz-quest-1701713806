...
class SecondMediumQuizPageNature extends StatefulWidget {
  const SecondMediumQuizPageNature({
    required this.image,
  ...
  @override
  State<SecondMediumQuizPageNature> createState() =>
      _SecondMediumQuizPageNatureState();
}

class _SecondMediumQuizPageNatureState extends State<SecondMediumQuizPageNature> {
  @override
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const MediumQuestionNatureQuizPage(),
                ));
              },
