...
class SecondMediumQuizPageGames extends StatefulWidget {
  const SecondMediumQuizPageGames({
    required this.image,
  ...
  @override
  State<SecondMediumQuizPageGames> createState() =>
      _SecondMediumQuizPageGamesState();
}

class _SecondMediumQuizPageGamesState extends State<SecondMediumQuizPageGames> {
  @override
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const MediumQuestionGamesQuizPage(),
                ));
              },
