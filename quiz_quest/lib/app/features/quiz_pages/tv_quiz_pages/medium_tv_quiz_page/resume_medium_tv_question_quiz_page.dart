...
class ResumeMediumTvQuizPageGames extends StatefulWidget {
  const ResumeMediumTvQuizPageGames({
  ...
  @override
  State<ResumeMediumTvQuizPageGames> createState() =>
      _ResumeMediumTvQuizPageGamesState();
}

class _ResumeMediumTvQuizPageGamesState extends State<ResumeMediumTvQuizPageGames> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ResumePage(
        badAnswers: mediumTvBadAnswers,
