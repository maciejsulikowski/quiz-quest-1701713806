...
import 'package:quiz_quest/app/features/quiz_pages/general_quiz_pages/hard_general_quiz_page/hard_general_answer_button.dart';
...
import 'package:quiz_quest/app/features/quiz_pages/general_quiz_pages/hard_general_quiz_page/hard_general_question_widget.dart';
...
class HardQuestionGeneralQuizPage extends StatefulWidget {
  const HardQuestionGeneralQuizPage({
    super.key,
  });

  @override
  State<HardQuestionGeneralQuizPage> createState() =>
      _HardQuestionGeneralQuizPageState();
}
...
bool isTimeUp = false;
late int hardGeneralGoodAnswers;
late int hardGeneralBadAnswers;
bool isCorrectAnswer = false;
String threeLives = '❤️❤️❤️';
String twoLives = ' ❤️❤️';
String oneLive = ' ❤️';

class _HardQuestionGeneralQuizPageState
    extends State<HardQuestionGeneralQuizPage> {
  int currentIndex = 0;
  ...
  @override
  void initState() {
    hardGeneralGoodAnswers = 0;
    hardGeneralBadAnswers = 0;
    currentAnswers = [];
    answerColors;
    ...
    return Scaffold(
      body: MultiBlocProvider(
        providers: [
          BlocProvider(
            create: (context) =>
                getIt<GeneralCubit>()..getHardGeneralCategory(),
          ),
          BlocProvider(
        ...
        child: BlocListener<GeneralCubit, GeneralState>(
          listener: (context, state) async {
            if (state.status == Status.error) {
              ...
              context.read<GeneralCubit>().getHardGeneralCategory();
            }
          },
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: Text(
                                  hardGeneralBadAnswers == 0
                                      ? threeLives
                                      : hardGeneralBadAnswers == 1
                                          ? twoLives
                                          : hardGeneralBadAnswers == 2
                                              ? oneLive
                                              : '',
                                  style: GoogleFonts.aBeeZee(
                                    fontSize: 20,
                    ...
                    CountDownTimer(
                      setDurationEnd: (value) {
                        setState(() {
                          ...
                          isTimeUp = true;
                          if (hardGeneralBadAnswers == 3) {
                            context
                                .read<GeneralCubit>()
                                .updateHardGeneralPoints(
                                    hardGeneralGoodAnswers);
                            context
                                .read<RankingCubit>()
                                .updateHardGeneralRankingPoints(
                                    hardGeneralGoodAnswers);
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) => HardGeneralLostLifePage(
                                    goodAnswers: hardGeneralGoodAnswers),
                              ),
                            );
                          }
                        });
                                                    ...
                                                    setState(() {
                                                      if (currentIndex ==
                                                        ...
                                                        Navigator.of(context)
                                                          ...
                                                          MaterialPageRoute(
                                                            builder: (context) =>
                                                                ResumeHardGeneralQuizPageGames(
                                                              badAnswers:
                                                                  hardGeneralBadAnswers,
                                                              goodAnswers:
                                                                  hardGeneralGoodAnswers,
                                                            ),
                                                          ),
