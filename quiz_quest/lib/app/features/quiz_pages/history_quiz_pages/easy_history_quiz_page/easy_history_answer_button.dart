...
class EasyHistoryAnswerButton extends StatefulWidget {
  ...
  @override
  State<EasyHistoryAnswerButton> createState() =>
      _EasyHistoryAnswerButtonState();
}

class _EasyHistoryAnswerButtonState extends State<EasyHistoryAnswerButton> {
  void onPressed() {
    if (isButtonDisabled) {
      return;
    }
    ...
    if (widget.isCorrectAnswer) {
      ...
      if (easyHistoryBadAnswers == 3) {
        context
            ...
            context
            .read<RankingCubit>()
            .updateEasyHistoryRankingPoints(easyHistoryGoodAnswers);
