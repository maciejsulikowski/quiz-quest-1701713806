...
class EasyQuestionNatureQuizPage extends StatefulWidget {
  ...
  @override
  State<EasyQuestionNatureQuizPage> createState() =>
      _EasyQuestionNatureQuizPageState();
}
...
bool isTimeUp = false;
late int easyNatureGoodAnswers;
late int easyNatureBadAnswers;
...
class _EasyQuestionNatureQuizPageState extends State<EasyQuestionNatureQuizPage> {
  ...
  @override
  void initState() {
    easyNatureGoodAnswers = 0;
    easyNatureBadAnswers = 0;
    currentAnswers = [];
    answerColors;
        ...
        child: BlocListener<NatureCubit, NatureState>(
          listener: (context, state) async {
            if (state.status == Status.error) {
              ...
              context.read<NatureCubit>().getEasyNatureCategory();
            }
          },
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                'Score: ${easyNatureGoodAnswers * 10}',
                            ...
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) => EasyNatureLostLifePage(
                                    goodAnswers: easyNatureGoodAnswers),
                              ),
                            );
                          }
                        });
                                                    ...
                                                    setState(() {
                                                      if (currentIndex ==
                                                        ...
                                                        Navigator.of(context)
                                                          ...
                                                          MaterialPageRoute(
                                                            builder: (context) =>
                                                                ResumeEasyNatureQuizPageGames(
                                                              badAnswers:
                                                                  easyNatureBadAnswers,
                                                              goodAnswers:
