...
class ResumeMediumGeneralQuizPageGames extends StatefulWidget {
  const ResumeMediumGeneralQuizPageGames({
  ...
  @override
  State<ResumeMediumGeneralQuizPageGames> createState() =>
      _ResumeMediumGeneralQuizPageGamesState();
}

class _ResumeMediumGeneralQuizPageGamesState
    extends State<ResumeMediumGeneralQuizPageGames> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ResumePage(
        badAnswers: mediumGeneralBadAnswers,
