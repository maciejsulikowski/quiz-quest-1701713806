...
class EasyGeographyAnswerButton extends StatefulWidget {
  ...
  @override
  State<EasyGeographyAnswerButton> createState() =>
      _EasyGeographyAnswerButtonState();
}

class _EasyGeographyAnswerButtonState extends State<EasyGeographyAnswerButton> {
  void onPressed() {
    if (isButtonDisabled) {
      return;
    }
    ...
    if (widget.isCorrectAnswer) {
      ...
      if (easyGeographyBadAnswers == 3) {
        context
            ...
            context
            .read<RankingCubit>()
            .updateEasyGeographyRankingPoints(easyGeographyGoodAnswers);
