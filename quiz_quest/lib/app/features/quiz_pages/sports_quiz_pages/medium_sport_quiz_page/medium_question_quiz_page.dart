...
import 'package:quiz_quest/app/features/quiz_pages/sports_quiz_pages/medium_sport_quiz_page/medium_sport_answer_button.dart';
...
import 'package:quiz_quest/app/features/quiz_pages/sports_quiz_pages/medium_sport_quiz_page/medium_sport_question_widget.dart';
...
class MediumQuestionSportQuizPage extends StatefulWidget {
  ...
  @override
  State<MediumQuestionSportQuizPage> createState() =>
      _MediumQuestionSportQuizPageState();
}
...
bool isTimeUp = false;
late int mediumSportGoodAnswers;
late int mediumSportBadAnswers;
bool isCorrectAnswer = false;
String threeLives = '❤️❤️❤️';
String twoLives = ' ❤️❤️';
String oneLive = ' ❤️';

class _MediumQuestionSportQuizPageState
    extends State<MediumQuestionSportQuizPage> {
  int currentIndex = 0;
  ...
  @override
  void initState() {
    mediumSportGoodAnswers = 0;
    mediumSportBadAnswers = 0;
    currentAnswers = [];
    answerColors;
        ...
        child: BlocListener<SportCubit, SportState>(
          listener: (context, state) async {
            if (state.status == Status.error) {
              ...
              context.read<SportCubit>().getMediumSportsCategory();
            }
          },
                            ...
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) => MediumSportLostLifePage(
                                    goodAnswers: mediumSportGoodAnswers),
                              ),
                            );
                          }
                        });
                                                            ...
                                                            if (currentIndex ==
                                                              ...
                                                              Navigator.of(
                                                                ...
                                                                MaterialPageRoute(
                                                                  builder:
                                                                      (context) =>
                                                                          ResumeMediumSportQuizPageGames(
                                                                    badAnswers:
                                                                        mediumSportBadAnswers,
                                                                    goodAnswers:
                                                                        mediumSportGoodAnswers,
                                                                  ),
                                                                ),
