...
class MediumMusicAnswerButton extends StatefulWidget {
  ...
  @override
  State<MediumMusicAnswerButton> createState() =>
      _MediumMusicAnswerButtonState();
}

class _MediumMusicAnswerButtonState extends State<MediumMusicAnswerButton> {
  void onPressed() {
    if (isButtonDisabled) {
      return;
    }
    ...
    if (widget.isCorrectAnswer) {
      ...
      if (mediumMusicBadAnswers == 3) {
        context
            ...
            context
            .read<RankingCubit>()
            .updateMediumMusicRankingPoints(mediumMusicGoodAnswers);
