...
class SecondMediumQuizPageSport extends StatefulWidget {
  const SecondMediumQuizPageSport({
    required this.image,
  ...
  @override
  State<SecondMediumQuizPageSport> createState() =>
      _SecondMediumQuizPageSportState();
}

class _SecondMediumQuizPageSportState extends State<SecondMediumQuizPageSport> {
  @override
    ...
    return Container(
      ...
      child: ListView(
        children: [
          ...
          Center(
            child: Text(
              'Your record in easy category: $mediumCategory💎',
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const MediumQuestionSportQuizPage(),
                ));
              },
