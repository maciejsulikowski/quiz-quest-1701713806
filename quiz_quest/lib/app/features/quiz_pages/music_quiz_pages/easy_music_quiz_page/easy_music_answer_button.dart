...
class EasyMusicAnswerButton extends StatefulWidget {
  ...
  @override
  State<EasyMusicAnswerButton> createState() => _EasyMusicAnswerButtonState();
}

class _EasyMusicAnswerButtonState extends State<EasyMusicAnswerButton> {
  void onPressed() {
    if (isButtonDisabled) {
      return;
    }
    ...
    if (widget.isCorrectAnswer) {
      ...
      if (easyMusicBadAnswers == 3) {
        ...
        context.read<RankingCubit>().updateEasyMusicRankingPoints(easyMusicGoodAnswers);
