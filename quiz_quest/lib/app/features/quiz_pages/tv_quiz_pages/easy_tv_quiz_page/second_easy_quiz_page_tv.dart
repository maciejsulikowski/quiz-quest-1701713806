...
class SecondEasyQuizPageTv extends StatefulWidget {
  const SecondEasyQuizPageTv({
    required this.image,
  ...
  @override
  State<SecondEasyQuizPageTv> createState() =>
      _SecondEasyQuizPageTvState();
}

class _SecondEasyQuizPageTvState extends State<SecondEasyQuizPageTv> {
  @override
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const EasyQuestionTvQuizPage(),
                ));
              },
