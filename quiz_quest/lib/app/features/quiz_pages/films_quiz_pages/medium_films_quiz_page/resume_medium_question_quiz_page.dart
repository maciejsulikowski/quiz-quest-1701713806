...
class ResumeMediumQuizPageFilms extends StatefulWidget {
  ...
  @override
  State<ResumeMediumQuizPageFilms> createState() =>
      _ResumeMediumQuizPageFilmsState();
}

class _ResumeMediumQuizPageFilmsState extends State<ResumeMediumQuizPageFilms> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ResumePage(
        badAnswers: mediumFilmsBadAnswers,
