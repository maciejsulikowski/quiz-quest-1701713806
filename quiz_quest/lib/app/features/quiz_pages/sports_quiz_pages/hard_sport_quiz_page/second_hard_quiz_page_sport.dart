...
class SecondHardQuizPageSport extends StatefulWidget {
  const SecondHardQuizPageSport({
    required this.image,
  ...
  @override
  State<SecondHardQuizPageSport> createState() =>
      _SecondHardQuizPageSportState();
}

class _SecondHardQuizPageSportState extends State<SecondHardQuizPageSport> {
  @override
    ...
    return Container(
      ...
      child: ListView(
        children: [
          ...
          Center(
            child: Text(
              'Your record in easy category: $hardCategory💎',
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const HardQuestionSportQuizPage(),
                ));
              },
