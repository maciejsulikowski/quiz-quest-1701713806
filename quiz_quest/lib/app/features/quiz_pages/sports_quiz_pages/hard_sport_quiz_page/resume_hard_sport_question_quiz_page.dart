...
class ResumeHardSportQuizPageGames extends StatefulWidget {
  const ResumeHardSportQuizPageGames({
  ...
  @override
  State<ResumeHardSportQuizPageGames> createState() =>
      _ResumeHardSportQuizPageGamesState();
}

class _ResumeHardSportQuizPageGamesState
    extends State<ResumeHardSportQuizPageGames> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: ResumePage(
        badAnswers: hardSportBadAnswers,
