...
class SecondEasyQuizPageNature extends StatefulWidget {
  const SecondEasyQuizPageNature({
    required this.image,
  ...
  @override
  State<SecondEasyQuizPageNature> createState() =>
      _SecondEasyQuizPageNatureState();
}

class _SecondEasyQuizPageNatureState extends State<SecondEasyQuizPageNature> {
  @override
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => const EasyQuestionNatureQuizPage(),
                ));
              },
