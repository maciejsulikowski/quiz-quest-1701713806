...
class ComputerScienceRepository {
  ComputerScienceRepository(this.computerScienceCategoryDataSource);
  ...
  Future<ComputerScienceQuizModel?> getComputerScienceData() async {
    final json =
        await computerScienceCategoryDataSource.getComputerScienceCategory();
