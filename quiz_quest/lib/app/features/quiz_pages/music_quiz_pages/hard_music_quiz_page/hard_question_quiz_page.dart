...
class HardQuestionMusicQuizPageState extends State<HardQuestionMusicQuizPage> {
  int currentIndex = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: MultiBlocProvider(
        providers: [
          BlocProvider(
            create: (context) => getIt<MusicCubit>()..getHardMusicCategory(),
          ),
          BlocProvider(
